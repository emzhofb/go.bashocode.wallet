...
const file_user_user_proto_rawDesc = "" +
	...
	"\rpassword_hash\x18\x05 \x01(\tR\fpasswordHash2\x8b\x01\n" +
	"\vUserService\x126\n" +
	"\aGetUser\x12\x14.user.GetUserRequest\x1a\x15.user.GetUserResponse\x12D\n" +
	"\x0eGetUserByEmail\x12\x1b.user.GetUserByEmailRequest\x1a\x15.user.GetUserResponseB(Z&github.com/emzhofb/gowallet/proto/userb\x06proto3"
