# Episode21: Memecah Auth Service
...
2. **Komunikasi:** Auth Service akan memvalidasi kredensial login dengan meminta data hash password dari User Service melalui gRPC (akan dibahas di Episode23).
