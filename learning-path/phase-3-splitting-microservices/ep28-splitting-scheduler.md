# Episode28: Memecah Scheduler Service
...
* Memisahkan logika background jobs (dari Episode15) menjadi daemon service mandiri.
...
Di fase monolith (Episode15), background scheduler berjalan di dalam aplikasi utama dan memiliki akses langsung ke database serta repository domain lain.
